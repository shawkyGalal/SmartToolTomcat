...
<table width="53%" border="1">
	...
	<% for (int i =0; i < conParms.size() ; i++)
      ...
      %>
	<tr>
		<td><input type="text" name="type<%=i%>"
...
<p align="left"><font size="5"><strong>2- Query
...
<p><input type="submit" name="Apply" value="Apply"> <input
	type="submit" name="connTest" value="Test Connection"></p>
</div>
