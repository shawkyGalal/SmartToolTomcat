...
<% 	
	if ( smartToolAdmin ) 
	{ 
	%> <frame src="editQuery.jsp?<%=request.getQueryString()%>" 	name="editorFrame" scrolling="Yes">  <% 
	} 
%>
	<frame src="executeQuery.jsp?<%=request.getQueryString()%>" 	name="executeAndParamFrame">
