...
<link href="<%=appURL%>/jQueryAssets/jquery.ui.theme.min.css" rel="stylesheet" type="text/css">
	...
	<title>زهوة لتأجير السيارات- Smart Value </title>
...
<table>
<tr><td width="300">
    <iframe src="/SmartTool/Company/6/images/Logo.jpg" 
    		width="250"
    		height="650"
    		scrolling="no"
    		frameborder="0"
...
<% 
	...
	{ 
	 ...
	 loginPageCookie.setValue("Company/6/loginScreen.jsp") ;
  ...
  <p><font size="4">سمارت فاليو لتطوير الانظمة</font>
  	<br><font size="6">   زهوة لتأجير السيارات     </font> 
  </p>
  <p> <font size="2"> بالمملكة العربية السعودية </font> </p>
  <table>
  	<tr>
  		<td><div align="center"><big>
  		<img src="<%=appURL%>/Company/6/images/Logo.jpg" style="height: 96px; width: 136px"></big><font size="2"><big>&nbsp;</big></font></div> </td>
