...
<link href="<%=appURL%>/jQueryAssets/jquery.ui.theme.min.css" rel="stylesheet" type="text/css">
	...
	<title>إدارة الاسطول SaudiBell- Smart Value </title>
...
<table>
<tr><td>
    <iframe src="<%=appURL%>/Company/2/images/logo_bell.jpg" 
    		width="250"
    		height="650"
    		scrolling="no"
    		frameborder="0"
...
<% 
  ...
  <p><font size="4">سمارت فاليو لتطوير الانظمة</font>
  	<br><font size="6"><a href = "http://www.muraishid.com/">  شركة الجرس  للمقاولات   </a> <p>      نظام إدارة اسطول سيارات الشركة  </p>  </font>  
  </p>
  <p> <font size="2"> بالمملكة العربية السعودية </font> </p>
  <table>
  	<tr>
  		<td><div align="center"><big>
  		<a href = "http://www.saudibell.com/" ><img title = "Saudi Bell was part of the Al Mazrou Group and established in 1982 under the Chairmanship of Mr. Mohammed Al Mazrou. The Group subsequently became the Saudi Bell Group. " src="<%=appURL%>/Company/2/images/logo_bell.jpg" style="height: 96px; width: 136px"></a></big><font size="2"><big>&nbsp;</big></font></div> </td>
