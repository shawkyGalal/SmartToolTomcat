...
<link href="<%=appURL%>/jQueryAssets/jquery.ui.theme.min.css" rel="stylesheet" type="text/css">
	<title> الأمل لتأجير السيارات - Smart Value </title>
...
<tr><td width="300">
	xx
    <!-- 
    <iframe src="Carrent/Amira/images/airPortBranchx.gif" 
    		width="250"
    		height="650"
    		scrolling="no"
    		frameborder="0"
...
<% 
	...
	{ 
	 ...
	 loginPageCookie.setValue("Company/2/loginScreen_demo.jsp") ;
	 loginPageCookie.setMaxAge(24*60*60);
	 loginPageCookie.setPath("/");
	 response.addCookie(loginPageCookie);


	String defaultEnv = "CARRENT_DEMO" ; 
	String reportTopOpen = "27941" ;  //"23700" ; 
  ...
  <p><font size="4">سمارت فاليو لتطوير الانظمة</font>
  	<br><font size="6"><a href = "http://www.Alamal.com/">  شركة الأمل    </a> <p>      النظام السحابى لإدارة شركات تأجير السيارات  </p>  </font>  
  </p>
  <p> <font size="2"> بالمملكة العربية السعودية </font> </p>
  <p> <font size="2"> carrent نموذج تجريبى - ارسل رسالة بها كلمة   </font>
  <p> <font size="2"> الى 0564627751 للحصول على اسم مستخدم و كلمة مرور  </font> </p>
  <table>
  	<tr>
  		<td><div align="center"><big>
  		<img src="/SmartTool/Company/demo/images/Logo.jpg" title="سوف يظهر اللوجو الخاص بشركتك هنا" style="height: 96px; width: 136px"></big><font size="2"><big>&nbsp;</big></font></div> </td>
		<td style="width: 78px"></td>
		<td><div align="center"><font size="2"><a href="http://www.smart-value.com"><big><img src="/SmartTool/images/smart-value.bmp" alt="Click to visit Smart Value Web Site" width="174" height="80" border="0"></big></a></font></div></td>
	</tr>
	</table>
</div>
