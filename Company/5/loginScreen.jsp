...
<html>
<head>
<link rel="shortcut icon" href="/SmartTool/Company/5/images/logo.ico">
...
<link href="<%=appURL%>/jQueryAssets/jquery.ui.theme.min.css" rel="stylesheet" type="text/css">
	...
	<title>أميرة لتأجير السيارات- Smart Value </title>
...
<% 
	...
	{ 
	 ...
	 loginPageCookie.setValue("Company/5/loginScreen.jsp") ;
  ...
  <p><font size="4">سمارت فاليو لتطوير الانظمة</font>
  	<br><font size="6"><a href = "http://www.muraishid.com/">    شركة أميرة     </a> <p>      نظام إدارة شركا ت تأجير السيارات  </p>  </font>  
  </p>
  <p> <font size="2"> بالمملكة العربية السعودية </font> </p>
  <table>
  	<tr>
  		<td><div align="center"><big>
  		<img src="../demo/images/Logo.jpg" title="سوف يظهر اللوجو الخاص بشركتك هنا" style="height: 96px; width: 136px"></big><font size="2"><big>&nbsp;</big></font></div> </td>
