...
<% Support.ConnParms selectedConnParms = (Support.ConnParms)session.getAttribute("selectedConnParms"); 
      ...
      %>
	   ...
	   <h1 title = "<%= queryHyperLinkTitle%>"> 
	   		...
	   		<%=queryDesc %> <%=(isSmartToolAdmin)? nodeHelpLink : "" %></font> 
	   	</h1>
    ...
    <div class="<%=htmlClass%>" style="margin-top:22px">
		...
		<input type="submit" class="btn-success btn" id = "updateOnlyButtonId" name="updateOnly" <%= ( (! isSmartToolAdmin)? " style=\"display: none;\"  " : "" ) %> 	value="Update Only">
	</div>
