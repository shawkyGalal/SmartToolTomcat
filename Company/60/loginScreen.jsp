...
<html lang="en" class="coming-soon">
  <head>
    <meta charset="utf-8">
    <title>نظام إدارة مراكز التدريب - سارة مجدى</title>
  ...
  <body class="coming-soon rtl">
   <% 
	...
	{ 
	 ...
	 loginPageCookie.setValue("Company/60/loginScreen.jsp") ;
	...
	<div class="row">
		<div class="col-md-4 col-md-offset-4">
            ...
            <div class="text-center titlehomecom">
                <a href="#" class="logostock"><img src="<%=appURL%>/Company/60/saraMagdyLogo.jpg" width="500" height="150"></a>
                <span>
					 سارة مجدي - مراكز تدريب اورجين 
					<br>للشهادات الاجنبية 
                </span>
            </div>
      ...
      <div class="footerfix">
          ...
          Copyright © 2000,2017
          <img src="../20/images/HuloolLogo.png" /> 
