...
<html lang="en" class="coming-soon">
  <head>
    <meta charset="utf-8">
    <title>جامعة الاميرة نورة-نظام التدريب الصحي</title>
	...
	<div class="row">
		<div class="col-md-4 col-md-offset-4">
            ...
            <div class="text-center titlehomecom">
                <a href="#" class="logostock"><img src="<%=appURL%>/StudentsIS/Pnu/images/logo.png" width="160" height="160"></a>
                <span>
					وكالة الجامعة للشئون الصحية 
					<br>نظام متابعة و إدارة التدريب السريرى للطالبات
                </span>
            </div>
