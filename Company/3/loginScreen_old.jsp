...
<link href="<%=appURL%>/jQueryAssets/jquery.ui.theme.min.css" rel="stylesheet" type="text/css">
	...
	<title>جامعة الاميرة نورة - Smart Value </title>
...
<table>
<tr><td width="300">
    <iframe src="/SmartTool/Company/3/images/logo.png" 
    		width="250"
    		height="650"
    		scrolling="no"
    		frameborder="0"
...
<% 
   ...
   %>
   <p align="center">
   Google Chrome is the Recommended Browser for this System ...<a href= "https://www.google.com/chrome/browser/desktop/" target = "Google Chrome DownLoad" > DownLoad Google Chrome</a>
   </p>
   
    <br><div align="center"> 
  <p><font size="4">سمارت فاليو لتطوير الانظمة</font>
  	<br><font size="6">   جامعة الاميرة نوره بنت عبد الرحمن    <p>     نظام لجنة الإحصاء و المعلومات   </p>  </font> 
  </p>
  <p> <font size="2"> بالمملكة العربية السعودية </font> </p>
  <table>
  	<tr>
  		<td><div align="center"><big>
  		<img src="<%=appURL%>/StudentsIS/Pnu/images/logo.png" style="height: 96px; width: 136px"></big><font size="2"><big>&nbsp;</big></font></div> </td>
        ...
        */
        String message = userName.toUpperCase() + " Have logged now to "+selectedConnParms.name+" using Support Tool from machine  "  +remoteAddr  + " From Mac Address: " + remoteMac;
         String[] to = {supporEmailReciver};
	      ...
	      Support.mail.MailSender ms = new Support.mail.MailSender(defaultEnv , "pnu" , "123");
