...
<html lang="en" class="coming-soon">
  <head>
    <meta charset="utf-8">
    <title>NGO Information Management System</title>
  ...
  <body class="coming-soon rtl">
   <% 
	...
	{ 
	 ...
	 loginPageCookie.setValue("Company/30/loginScreen.jsp") ;
	...
	<div class="row">
		<div class="col-md-4 col-md-offset-4">
            ...
            <div class="text-center titlehomecom">
                ...
                <a href="#" class="logostock"><img src="assets/img/logo-dark.png"></a>
                <span>
                   A Complete Information Management System for Non Governmental Organizations</span>
                <p>
			...
			<div class="panel panel-default alt with-footer">
				...
				<div class="panel-body">
					...
					<form action="" class="" id="validate-form" method="post" >
