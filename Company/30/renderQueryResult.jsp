...
<!--  Scripts To Enable Pivot Table Renderer  -->
	...
	<!--  Enable Google Charts -->
		<script type="text/javascript" src="<%=appURL%>/includes/www.google.com/jsapi"></script>
...
<script	language="JavaScript" type="text/JavaScript">
	...
	<img title="Show Pivot Table"  name="toggleViewPivitTable_<%=queryIndex %>" src="<%=appURL%>/images/PivotTable.ico" height="30" onclick="toggleShowPivotTable_<%=queryIndex %>(true);">
...
<img title="Show Table Filtering"  name="toggleViewPivitTable_<%=queryIndex %>" src="<%=appURL%>/images/tableFilterIco.jpg" height="30" onclick="showTableFiltering_<%=queryIndex %>();">
<img title = "Transpose Table" height="25" src = "<%=appURL%>/images/transpose_thumb.png" id = "transposeLink" onclick = "TransposeTable('resSetTable<%=id%>_<%=queryIndex %>');"></img>
<%
...
<table border = 1 class="table table-striped table-vam table-bordered mb0 " id = "resSetTable<%=id%>_<%=queryIndex %>" >
	<thead>
	<tr>
		<%
