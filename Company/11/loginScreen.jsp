  ...
  if (conObj != null )
     { 
      try
      {
        ...
        UserUnCommitedTransactions.rollBackConnection(con , session ) ;
        con.close();
...
<%  
		cookie = Misc.getCookiByName ( request , "comeFrom") ; 
		String comeFrom = (cookie!= null) ? cookie.getValue() : null ;

      if (comeFrom != null )
      {
    	  Cookie comeFromCokie = new Cookie("comeFrom", null); 
