...
<%@page import="com.sideinternational.sas.service.impl.CrystalReportService" %>
...
<%@page import="com.sideinternational.sas.service.impl.scdb.entity.Report"%>
<%@page import="com.sideinternational.clrt.config.impl.ClrtConfigXmlImpl"%>
...
<%------------Beginning of 'Open and View Report' snippet----------------%><%
	...
	String repPath =  session.getServletContext().getRealPath(""); //request.getRealPath("");
	String reportName ="Sample Reports/Oracle_Dept_emp.rpt" ; //"Sample Reports/eventsWithParam.rpt"; //  request.getParameter("reportName");//
...
//	if (reportSource == null)
	{	
	    ...
	    XmlRepParamDoc xx= new XmlRepParamDoc(request.getRealPath("Sample Reports\\XmlParameters")+"\\Report-Params_v2.xml");
	    ...
	    ReportClientDocument reportClientDocument = crs.getReportClientDocument(repPath + java.io.File.separator + reportName , parameters , ds);
